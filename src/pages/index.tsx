...
export const getStaticProps: GetStaticProps = async () => {
  ...
  const latestEpisodes = episodes.slice(0, 2); //Separa somente os dois primeiros episódios
  const allEpisodes = episodes.slice(2, episodes.length); //Pega o restante dos episódios
